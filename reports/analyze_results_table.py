...
fp = 'reports/tables/bert/main_results_table.csv'
orig_df = pd.read_csv(fp, index_col=False)
#orig_df = orig_df[orig_df.set_type != 'val']
#orig_df['h'] = None
#orig_df.loc[orig_df.model == 'cam','h'] = 500
#orig_df.loc[orig_df.model == 'cam250','h'] = 250
#orig_df.loc[orig_df.model == 'cam250','model'] = 'cam'
#orig_df.to_csv('reports/tables/main_results_table_h.csv', index=False)
