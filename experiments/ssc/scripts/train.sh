...
#export BERT_VOCAB=https://s3.amazonaws.com/models.huggingface.co/bert/bert-base-cased-vocab.txt
#export BERT_WEIGHTS=https://s3.amazonaws.com/models.huggingface.co/bert/bert-base-cased.tar.gz
