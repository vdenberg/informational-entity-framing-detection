...
class SeqClassificationModel(Model):
    ...
    def __init__(self, vocab: Vocabulary,
        ...
        #    {"bert": PretrainedTransformerEmbedder(transformer_model_name)})
       ...
       # define loss
        ...
        encoded_sentence_dim = self.text_field_embedder.get_output_dim()
    ...
    def forward(self,  # type: ignore
        ...
        if self.use_sep:
            ...
            SEP_INDEX = 3
            sentences_mask = sentences['bert'] == SEP_INDEX  # mask for all the SEP tokens in the batch
