...
export BERT_VOCAB=https://huggingface.co/allenai/news_roberta_base
export BERT_WEIGHTS=https://huggingface.co/allenai/news_roberta_base
...
# seed and fold combos that work:
# 199, 2
# 198, 2 (kindof)