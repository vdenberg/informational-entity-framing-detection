...
from allennlp.data.token_indexers import TokenIndexer, SingleIdTokenIndexer, wordpiece_indexer, PretrainedTransformerIndexer
...
class SeqClassificationReader(DatasetReader):
    ...
    def __init__(self,
        ...
        self._tokenizer = PretrainedTransformerTokenizer(transformer_model_name, add_special_tokens=False, calculate_character_offsets=True)
